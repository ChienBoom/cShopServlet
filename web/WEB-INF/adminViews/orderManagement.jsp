                                ...
                                <tr class="align-item-center">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <c:if test="${item.status != 'PENDDING'}">
                                                <button type="button" class="btn btn-primary" data-toggle="tooltip" title="Xác nhận đơn hàng"
                                                        disabled="">
                                                    <i class="fa-solid fa-circle-check"></i>
                                                </button>
                                            </c:if>
                                            ...
                                            <c:if test="${item.status == 'PENDDING'}">
                                                <button type="button" class="btn btn-primary" data-toggle="tooltip" title="Xác nhận đơn hàng"
                                                        data-bs-toggle="modal" data-bs-target="#ConfirmOrderModal" onclick="confirmOrder('${item.id}')">
                                                    <i class="fa-solid fa-circle-check"></i>
                                                </button>
                                            </c:if>
                                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="orderManagement" method="post">
                            ...
                            <div class="modal-body">
                                Bạn có chắc chắn muốn xác nhận đơn hàng này? <span id="delete-modal-body"></span>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="confirmOrderId" name="confirmOrderId" value="" hidden="">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="action" name="action" value="CONFIRM" hidden="">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Huỷ</button>
